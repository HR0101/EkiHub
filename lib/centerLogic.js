...
// 公平性スコアと近接スコアの重み（合計1.0）。時間補正を重視する配分
const WEIGHT_FAIRNESS = 0.6;
const WEIGHT_PROXIMITY = 0.4;
...
export async function computeCenterStation({
  ...
  for (const m of metrics) {
    ...
    m.score = WEIGHT_FAIRNESS * fairnessScore + WEIGHT_PROXIMITY * proximityScore;
  }
